 (function(e) {
     if (e.fn.ajaxForm == undefined) {
         e.getScript(("https:" == document.location.protocol ? "https://" : "http://") + "malsup.github.io/jquery.form.js")
     }
     var t = {};
     ...
     e.fn.uploadFile = function(n) {
         ...
         function g(t, n) {
             this.statusbar = e("<div class='ajax-file-upload-statusbar cb'></div>").width(n.statusBarWidth);
             ...
             this.filename = e("<div class='ajax-file-upload-filename fl'></div>").appendTo(this.statusbar);
             this.progressDiv = e("<div class='ajax-file-upload-progress fl'>").appendTo(this.statusbar).hide();
             this.progressbar = e("<div class='ajax-file-upload-bar " + t.formGroup + "'></div>").appendTo(this.progressDiv);
             this.abort = e("<div class='glyphicon glyphicon-remove " + t.formGroup + "' style='cursor: pointer'>" + n.abortStr + "</div>").appendTo(this.statusbar).hide();
             ...
             this.del = e("<div title='Delete' class='glyphicon glyphicon-trash'  style='cursor: pointer'>" + n.deletelStr + "</div>").appendTo(this.statusbar).hide();
         ...
         var r = e.extend({
             ...
             dragDropStr: "<span class='drag-and-drop-files'><b>Drag & Drop Files</b></span>",
             abortStr: "Abort",
             cancelStr: "Cancel",
             deletelStr: "Delete",
             doneStr: "Done",
         ...
         (function b() {
             if (e.fn.ajaxForm) {
                 if (r.dragDrop) {
                     var t = e('<div class="fl ajax-upload-dragdrop" style="vertical-align:top;"></div>').width(r.dragdropWidth);
                     e(s).before(t);
                     e(t).append(o);
         ...
         this.createProgress = function(e) {
             ...
             s.selectedFiles++;
             if (r.showPreview) {
                 t.preview.attr("src", r.uploadFolder + e);
                 t.preview.show()
             }
             if (r.showDownload) {
                 t.download.show();
