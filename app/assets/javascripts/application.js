...
//= require svg-donut-chart-framework
...
function sch_slide(){
   // $(".input-group .form-control.srch_fld").animate({ backgroundColor: '#fff', color: '#000000'}, 200);
   // $(".input-group .form-control.srch_fld").blur(function(){
   //    if($(".input-group .form-control.srch_fld").val() == ""){
   //     $(this).animate({ backgroundColor:'#b4f5e8', color: '#ffffff'}, 400);
   //   }
   // }); 
}  
...
function getStages(id){
  ...
  function show_alert_message(priority,msg){
    ...
    $(".data-box div").css({"display":"inline-block"});
