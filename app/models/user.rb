...
class User < ActiveRecord::Base
  ...
  attr_accessible :email, :password, :password_confirmation,
                  ...
                  :first_name, :last_name, :work_phone, :role_id, :profile_image, :confirmed_at, :confirmation_token, :is_beta_user,:priority_label,:digest_mail_date, :organization_id, :is_blocked
  ...
  def self.to_csv
    CSV.generate do |csv|
      csv << ["First name", "Last name", "Email", "Role", "Created on", "Leads", "Tasks", "Activities"] ## Header values of CSV
      all.each do |user|
        ...
        csv << [user.first_name, 
                ...
                user.activities.count ] ##Row values of CSV
      end
    end
  end
