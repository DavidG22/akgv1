SalesCafe::Application.routes.draw do
  ...
  match '/bug_reports' => 'home#report_a_bug'
  ...
  match '/delete_emails' => 'deals#delete_emails'
  match '/archive_emails' => 'deals#archive_emails'

  get 'get_day_reminder' => 'reminders#get_day_reminder'
  get 'get_day_reminder' => 'home#dashboard'
  ...
  match 'invite_demo_user' => 'users#invite_demo_user'
  ...
  match 'get_qualify_deals' => 'deals#get_qualify_deals', :via => [:post], :as => 'get_qualify_deals'
  match 'get_not_qualify_deals' => 'deals#get_not_qualify_deals', :via => [:post], :as => 'get_not_qualify_leads'
  ...
  match '/get_reports' => 'reports#new_report'
  match '/get_selected_filter' => 'reports#get_selected_filter'
  match '/reload_left_side_content' => 'reports#reload_left_side_content'
  match '/generate_report' => 'reports#generate_report'
